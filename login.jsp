...
<body>
	<form action="./Admin_Student_Home2Controller" method="get">

	<div class=" p-5 bg-warning text-white rounded">
		<h1 style="text-align:center">Student Marks Management System</h1>
		<p style="text-align:center">User friendly tool for student marks management .useful in all colleges and educational institutions</p>
		
		<div class="text-center">
	<button  class="btn btn-primary" >click me</button>
	</div>	
	</div>
<div class="container1 w-95">
<div class="card p-4 w-100" style="max-width: 700px;" >
  <div class="row g-0">
    ...
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title text-start mb-3">Student-Login</h5>
        <form style="max-width:350px;">
        <div class="form-floating mb-3">
 <input type="text" class="form-control" id="floatingUsername" placeholder="Enter your username" required>
