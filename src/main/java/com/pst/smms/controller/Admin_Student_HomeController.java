...
@WebServlet("/Admin_Student_HomeController")
public class Admin_Student_HomeController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher dispatcher=request.getRequestDispatcher("./admin_student_home.jsp");
