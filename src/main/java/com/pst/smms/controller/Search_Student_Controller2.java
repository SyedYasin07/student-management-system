...
@WebServlet("/Search_Student_Controller2")
public class Search_Student_Controller2 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
	    ...
	    try {
	        ...
	        request.getRequestDispatcher("admin_student_home2.jsp").forward(request, response);
